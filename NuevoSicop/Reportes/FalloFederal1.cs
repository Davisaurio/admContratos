...
namespace NuevoSicop.Reportes {
    ...
    public class FalloFederal : ReportClass {
        ...
        public override string FullResourceName {
            get {
                return "NuevoSicop.Reportes.FalloFederal.rpt";
            }
            set {
                // Do nothing
            }
    ...
    public class CachedFalloFederal : Component, ICachedReport {
        
        public CachedFalloFederal() {
        }
        ...
        public virtual CrystalDecisions.CrystalReports.Engine.ReportDocument CreateReport() {
            FalloFederal rpt = new FalloFederal();
            rpt.Site = this.Site;
            return rpt;
        }
