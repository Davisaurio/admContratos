...
namespace NuevoSicop.Reportes {
    ...
    public class FalloEstatal : ReportClass {
        ...
        public override string FullResourceName {
            get {
                return "NuevoSicop.Reportes.FalloEstatal.rpt";
            }
            set {
                // Do nothing
            }
    ...
    public class CachedFalloEstatal : Component, ICachedReport {
        
        public CachedFalloEstatal() {
        }
        ...
        public virtual CrystalDecisions.CrystalReports.Engine.ReportDocument CreateReport() {
            FalloEstatal rpt = new FalloEstatal();
            rpt.Site = this.Site;
            return rpt;
        }
