...
{
    public class AdquisicionesModelView
    {

        public AdquisicionesModelView()
        {
            ...
            Error = "";
            Exito = "";
            PyContrato = new List<CVProyectoContrato>();
        }
        ...
        public List<CVProyectoContrato> PyContrato { get; set; }

        [DisplayName("Fianza de cumplimiento:")]
        public bool FianzaCumplimineto { get; set; }
    ...
    public class CVProyectoContrato
    {
        public int Idproyecto { get; set; }
        public string Proyecto { get; set; }
